...
class PropertyFileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = PropertyFile
        fields = [
            'id', 'file_url', 'category', 'file_name', 'file_type',
            'image_source',
            'uploaded_by_email', 'uploaded_by_role_name',
            'uploaded_at',
        ]
...
class PropertyListSerializer(serializers.ModelSerializer):
    ...
    def get_thumbnail_url(self, obj):
        request = self.context.get('request')
        # files are prefetched; filter in Python to avoid extra query
        image = next(
...
class PropertyMapSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'property_type', 'latitude', 'longitude', 'thumbnail_url',
        ]
